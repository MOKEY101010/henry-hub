...
local Window = OrionLib:MakeWindow({Name = "Henrique Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Henrique Hub"})
...
W:AddLabel("[+] Henrique Hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Henrique Hub(Noitification)",
